...
Double-clicking on the executable generated by complining the code shown above, will auto-close the program.

To avoid autoclosing, run your console apps from the command line instead, unless there is a loop in your program which avoids the problem.
